      ...
      <div
        ...
        <div
          ...
          className={classNames(
            ...
            "dark:bg-muted grid max-w-full items-start bg-white dark:[color-scheme:dark] sm:transition-[width] sm:duration-300 sm:motion-reduce:transition-none md:flex-row",
            ...
            (layout === BookerLayouts.MONTH_VIEW || isEmbed) && "border-gray rounded-md border",
            !isEmbed && "sm:transition-[width] sm:duration-300",
            isEmbed && layout === BookerLayouts.MONTH_VIEW && "border-gray sm:border-booker-width",
            !isEmbed && layout === BookerLayouts.MONTH_VIEW && "border-gray"
          )}>
          <AnimatePresence>
            {!isInstantMeeting && (
              <BookerSection
